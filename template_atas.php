...
<body>
	<div id="wrap">
		<div id="header">
			<h1><center>Gabriele Andhika D.K</center></h1>
		</div>
			...
			<div id="menu">
				...
				<div id="menu_konten">
					<ul>
						...
						<li><a style="<?php echo $tampil ?>" href="pengguna_isi.php">Input Pelanggan</a></li>
						<li><a style="<?php echo $tampil ?>" href="data_pelanggan.php">Data Pelanggan</a></li>
